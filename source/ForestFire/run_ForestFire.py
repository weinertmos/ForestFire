...
# Parameters
n_SVM = 10  # starting number of SVM runs before building RF = number of data points in first RF, minimum is 4!
...
n_trees = 'default'  # number of trees that stand in a forest, default = number of features * 3
...
scoref = 'giniimpurity'  # which scoring efficiency should be used (available: entropy and giniimpurity), default = entropy
...
Main.main_loop(n_SVM, pruning, min_data, n_forests, n_trees, n_configs_biased, n_configs_unbiased, multiplier_stepup, seen_forests,
